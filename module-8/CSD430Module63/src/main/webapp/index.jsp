...
<%
    /*
     * Retrieve all movie IDs so they can be displayed
     * in the Display and Update dropdown menus.
     */
...
<head>
    ...
    <style>
        * {
        ...
        .update-button:hover {
            background-color: #a97300 !important;
        }
...
<div class="container">
    ...
    <header>
        ...
        <p>Module 8.2 – Working with CRUD-UPDATE &amp; JavaBeans</p>
        <p>Project Part 3</p>
    </header>
